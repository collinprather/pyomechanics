...
def visualize_markers(session_swing="447_5", output_path="markers_visualization.gif"):
    """
    ...
    # Use all available markers instead of just key markers
    ...
    def animate(frame):
        ...
        ax.set_title(f'3D Marker Visualization - Session {session_swing}\nFrame {frame}/{len(markers.time)}', color='white')
        ...
        ax.grid(True, color='lightgrey', alpha=0.075)
...
if __name__ == "__main__":
    ...
    visualize_markers(session_swing="447_5", output_path="./viz/markers.gif")